...
#utils.encart(title: "Un coup de pouce", type: "info")[Certaines requêtes sont plus complexes que d'autres. Le LLM risque d'avoir peut être un peu de mal dans certains cas : n'hésitez pas à l'aider en lui donnant des indications sur la requête à écrire.]
