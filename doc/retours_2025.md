...
- Les étudiants se mélangent entre sudo docker et docker DONE
...
- déplacer le fait de couper/redémarrer le tf apply pour les containers (l'encart bleu) plus haut pour mieux aider les élèves DONE
- ils se trompent constamment de nom d'image à déployer, leur rappeler de bien la nommer <registry>/<image>:<tag> DONE
